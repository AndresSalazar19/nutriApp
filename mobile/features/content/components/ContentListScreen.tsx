    ...
    >
      ...
      <View style={styles.cardContent}>
          ...
          {item.is_premium && (
            <View style={styles.premiumTag}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                <MaterialCommunityIcons name="star-outline" size={12} color="#F57F17" />
        ...
        <View style={styles.cardFooter}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
            <MaterialCommunityIcons name="eye-outline" size={14} color="#aaa" />
    ...
    <SafeAreaView style={styles.root} edges={['top']}>
      ...
      >
        {ALL_CATEGORIES.map((cat) => {
          ...
          const accent =
            cat === 'Todas' ? COLORS.primary : (CATEGORY_ACCENT[cat] ?? COLORS.primary);
          return (
            <TouchableOpacity
              key={cat}
      ...
      {loading ? (
        ...
        <View style={styles.center}>
          <MaterialCommunityIcons name="book-open-page-variant-outline" size={56} color="#bbb" />
