...
class Food(Base):
    ...
    potassium_mg = Column(Numeric(7, 2), nullable=True)
    zinc_mg = Column(Numeric(7, 2), nullable=True)
    vitamin_a_ug = Column(Numeric(7, 2), nullable=True)
    folate_ug = Column(Numeric(7, 2), nullable=True)
