...
from app.schemas.educational_content import EducationalContentResponse, EducationalContentRequest
...
def create_educational_content(educational_content: EducationalContentRequest, db: Session = Depends(get_db)):
    created_content = EducationalContentService.create(db, educational_content, "5712dd83-17d5-484c-8b6a-00cf570b4564")
