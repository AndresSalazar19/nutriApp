...
export const AppointmentService = {
  ...
  async list(params: {
    ...
    const res = await fetch(`${API_URL}/appointment?${query.toString()}`, {
      method: 'GET',
      headers: authHeaders(),
    });
  ...
  async update(
    ...
    const res = await fetch(`${API_URL}/appointment/${appointment_id}`, {
      method: 'PATCH',
      headers: authHeaders(),
      body: JSON.stringify(payload),
    });
  ...
  async cancel(
    ...
    const res = await fetch(`${API_URL}/appointment/${appointment_id}?${query.toString()}`, {
      method: 'DELETE',
      headers: authHeaders(),
    });
