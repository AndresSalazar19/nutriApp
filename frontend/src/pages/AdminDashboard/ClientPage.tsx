...
const clientsMock: Client[] = [
  {
    id: '1', initials: 'MR', color: 'bg-admin-light',
  ...
  {
    id: '6', initials: 'PS', color: 'bg-admin-light',
  ...
  {
    id: '7', initials: 'CF', color: 'bg-admin-light',
...
const statsCards = [
  {
    icon: MdPeople, iconBg: 'bg-admin-light',   label: 'Total Clientes',
    value: '347', change: '↑ 23 este mes',     changeType: 'positive' as const, accentColor: 'text-gray-900',
  },
  {
    icon: MdDescription, iconBg: 'bg-admin-light', label: 'Suscripciones Activas',
    value: '289', change: '33% del total',      changeType: 'neutral'  as const, accentColor: 'text-gray-900',
  },
  {
    icon: MdNewReleases, iconBg: 'bg-admin-light',  label: 'Nuevos este mes',
    value: '23',  change: '↑ 12% vs mes anterior', changeType: 'positive' as const, accentColor: 'text-gray-900',
  },
  {
    icon: MdEmojiEvents, iconBg: 'bg-admin-light', label: 'Con Nutricionista',
    value: '334', change: '96% asignados',      changeType: 'positive' as const, accentColor: 'text-gray-900',
  },
];
  ...
  if (!nutritionist) {
    return (
      <div className="flex items-center gap-2">
        ...
        <span className="w-5 h-5 flex items-center justify-center rounded-full bg-admin-accent text-white text-xs font-bold">!</span>
      </div>
    );
  }
  return (
