...
export const MOCK_PATIENTS: Patient[] = [
  {
    ...
    nutritionalPlan: {
      id: 'p1', name: 'Plan Hiposódico - Octubre 2025',
      startDate: '1 de octubre de 2025',
      calories: 1800, sodium: 2000, compliance: 92,
    },
  },
  {
    id: '0023',
    ...
    weightHistory: [
      ...
      { date: '15 Nov', value: 90.1 }, { date: '01 Dic', value: 89.9 },
      { date: '15 Dic', value: 89.5 }, { date: '01 Ene', value: 89.2 },
      { date: '15 Ene', value: 89.0 },
    ],
    appointments: [
      { id: 'a3', date: 'Ayer', time: '3:30 PM', type: 'Presencial' },
    ],
    nutritionalPlan: {
      id: 'p2', name: 'Plan Hipocalórico - Septiembre 2025',
      startDate: '5 de septiembre de 2025',
      calories: 1600, sodium: 2500, compliance: 74,
    },
  },
  {
    id: '0034',
    ...
    weightChange: -0.8,
    weightHistory: [
      { date: '15 Oct', value: 65.5 }, { date: '01 Nov', value: 65.1 },
      { date: '15 Nov', value: 64.8 }, { date: '01 Dic', value: 64.5 },
      { date: '15 Dic', value: 64.2 }, { date: '01 Ene', value: 64.0 },
      { date: '15 Ene', value: 64.0 },
    ],
    appointments: [],
    nutritionalPlan: {
      id: 'p3', name: 'Plan Sin Gluten - Octubre 2025',
      startDate: '10 de octubre de 2025',
      calories: 1700, sodium: 2200, compliance: 88,
    },
  },
  {
    id: '0041',
    ...
    weightChange: -0.3,
    weightHistory: [
      { date: '15 Oct', value: 71.8 }, { date: '01 Nov', value: 71.6 },
      { date: '15 Nov', value: 71.5 }, { date: '01 Dic', value: 71.4 },
      { date: '15 Dic', value: 71.3 }, { date: '01 Ene', value: 71.1 },
      { date: '15 Ene', value: 71.0 },
    ],
    appointments: [],
    nutritionalPlan: {
      id: 'p4', name: 'Plan Tiroideo - Agosto 2025',
      startDate: '1 de agosto de 2025',
      calories: 1500, sodium: 1800, compliance: 61,
    },
  },
  {
    id: '0055',
    ...
    weightChange: 0.5,
    weightHistory: [
      { date: '15 Oct', value: 81.2 }, { date: '01 Nov', value: 81.5 },
      { date: '15 Nov', value: 81.8 }, { date: '01 Dic', value: 82.0 },
      { date: '15 Dic', value: 82.2 }, { date: '01 Ene', value: 82.3 },
      { date: '15 Ene', value: 82.0 },
    ],
    appointments: [],
    nutritionalPlan: {
      id: 'p5', name: 'Plan Cardioprotector - Julio 2025',
      startDate: '15 de julio de 2025',
      calories: 1900, sodium: 2300, compliance: 45,
    },
  },
];
