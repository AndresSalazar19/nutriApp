...
export const MOCK_REPORTS: Record<string, ReportData> = {
  '0012': {
    ...
    bloodPressureDia: 76,
    bloodPressureNote: 'Dentro del rango normal',
    adherence: 87,
    adherenceChange: 5,
    activityDays: 4.2,
    activityGoal: 5,
    activityNote: 'Estable',
    weightHistory: [
    ...
    systolicHistory: [
      { date: '15 Oct', value: 130 },
      { date: '01 Nov', value: 128 },
      { date: '15 Nov', value: 126 },
      { date: '01 Dic', value: 124 },
      { date: '15 Dic', value: 122 },
      { date: '01 Ene', value: 120 },
      { date: '15 Ene', value: 118 },
    ],
    diastolicHistory: [
      { date: '15 Oct', value: 84 },
      { date: '01 Nov', value: 83 },
      { date: '15 Nov', value: 82 },
      { date: '01 Dic', value: 80 },
      { date: '15 Dic', value: 79 },
      { date: '01 Ene', value: 77 },
    ...
    correlations: [
      {
        label: 'Sodio ↔ Presión Arterial',
        value: -0.72,
        description: 'Correlación negativa fuerte\n↓ Reducción de sodio efectiva',
        positive: true,
      },
      {
        label: 'Ejercicio ↔ Peso',
        value: -0.68,
        description: 'Correlación negativa fuerte\n↓ Actividad física efectiva',
        positive: true,
      },
      {
        label: 'Adherencia ↔ Resultados',
        value: +0.84,
        description: 'Correlación positiva muy fuerte\n↑ Alta adherencia = mejores resultados',
        positive: true,
      },
    ],
    weeklyActivity: [
  ...
  '0023': {
    ...
    bloodPressureDia: 85,
    bloodPressureNote: 'Levemente elevado',
    adherence: 74,
    adherenceChange: -2,
    activityDays: 2.8,
    activityGoal: 4,
    ...
    weightHistory: [
      ...
      { date: '15 Nov', value: 90.5 },
      { date: '01 Dic', value: 90.2 },
      { date: '15 Dic', value: 89.8 },
      { date: '01 Ene', value: 89.5 },
      { date: '15 Ene', value: 89.0 },
    ],
    systolicHistory: [
      { date: '15 Oct', value: 140 },
      { date: '01 Nov', value: 139 },
      { date: '15 Nov', value: 138 },
      { date: '01 Dic', value: 137 },
      { date: '15 Dic', value: 136 },
      { date: '01 Ene', value: 136 },
      { date: '15 Ene', value: 135 },
    ],
    diastolicHistory: [
      { date: '15 Oct', value: 90 },
      { date: '01 Nov', value: 89 },
      { date: '15 Nov', value: 88 },
      { date: '01 Dic', value: 87 },
      { date: '15 Dic', value: 86 },
      { date: '01 Ene', value: 86 },
    ...
    correlations: [
      ...
      },
      {
        label: 'Adherencia ↔ Resultados',
        value: +0.61,
        description: 'Correlación positiva moderada\nMejorar cumplimiento del plan',
        positive: true,
      },
    ],
    weeklyActivity: [
