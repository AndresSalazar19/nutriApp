...
import { MacroData } from '../mock/reportsMock';
  ...
  return (
    <svg viewBox={`0 0 ${W} ${H}`} className="w-full" style={{ height: H }}>
      ...
      <g>
        ...
        <text x={PAD.left + 11} y={H - 9} fontSize="9" fill="#6b7280">
          Consumido
        </text>
        <rect x={PAD.left + 68} y={H - 16} width="8" height="8" fill="#d1d5db" rx="2" />
        <text x={PAD.left + 80} y={H - 9} fontSize="9" fill="#9ca3af">
          Meta
        </text>
      </g>
    </svg>
